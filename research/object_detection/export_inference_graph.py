...
Example Usage:
--------------
python export_inference_graph.py --input_type image_tensor --pipeline_config_path training_rnn/faster_rcnn_inception_v2_coco.config --trained_checkpoint_prefix training_rnn/model.ckpt-6000 --output_directory rnn
